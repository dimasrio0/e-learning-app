		...
		<div class="container">
			...
			<?php if (isset($err)) : ?>
				<div class="alert alert-danger alert-dismissible fade show" role="alert">
					<strong>Username / Password Salah !</strong> Silahkan Cek kembali
			...
			<form method="post">
				<div class="input-group">
					...
					<input type="text" name="username" placeholder="Masukan Username" required class="form-control" autocomplete="off">
				</div>
				<br>
				<div class="input-group">
