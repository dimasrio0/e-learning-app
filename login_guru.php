...
<body>
	<div class="container">
    	<h2 align="center">Login guru</h2>
    	<hr class="bg-dark">
		<?php if (isset($err)): ?>
			<div class="alert alert-danger alert-dismissible fade show" role="alert">
  				<strong>NIP Tidak terdaftar !</strong> Silahkan Cek kembali
	...
	<form method="post">
		<div class="input-group">
			...
			<input type="number" name="nip" id="nip" placeholder="Masukan nip" required class="form-control" autocomplete="off">
		</div>
		<br>
