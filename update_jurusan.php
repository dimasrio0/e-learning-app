...
if (isset($_GET['id_jur'])) {
	$id = $_GET['id_jur'];
	$result = mysqli_query($koneksi, "SELECT * FROM tb_jurusan where id = '$id' ");
                            ...
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="mm-active">
                                    ...
                                    <ul class="mm-show">
                                        ...
                                        <li>
                                            <a href="?hal=jurusan"  class="mm-active">
                                                <i class="metismenu-icon">
                                                </i>Jurusan
                                            </a>
                                        </li>
                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                            	...
                            	<div>Data <?php echo $row['nama'] ?>
                                    <div class="page-title-subheading">Ubah data Jurusan</div>
                            	</div>
                            </div>
                        </div>
                    </div>
					...
					<div class="main-card mb-3 card ml-4 mt-0 mr-4">
                                    <div class="card-body mt-2"><h4 class="card-title">Ubah</h4>
                                        <form method="post" action="proses_update.php">
                                            ...
                                            <div class="position-relative row form-group mt-5"><label class="col-sm-2 col-form-label" for="nama_jurusan">Nama Jurusan</label>
                                                <div class="col-sm-10"><input name="nama_jurusan" class="form-control" id="nama_jurusan" type="text" required autocomplete="off" placeholder="Masukan nama_jurusan" value="<?php echo $row['nama'] ?>"></div>
                                            </div>
                                            <div class="position-relative row mt-5 mb-5">
                                                <div class="col-sm-10 offset-sm-2">
                                                    <button class="btn btn-success" type="submit" name="ubah_jurusan">Simpan</button>
                                                    <a href="beranda.php?hal=jurusan" class="btn btn-danger">Batal</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
